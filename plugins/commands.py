...
async def start(client, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 Source', url='https://t.me/mjsqueen786')
        ],
        [
...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of this bot is not public hope you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons))
