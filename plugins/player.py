...
async def not_chat(_, m: Message):
    buttons = [
        [
            InlineKeyboardButton('⚡️Make Own Bot', url='https://t.me/mjsqueen786'),
            InlineKeyboardButton('🧩 Join Here', url='https://t.me/mjsqueen786'),
        ]
        ]
    await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SUPPORT GROUP](https://t.me/mjsqueen786) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
